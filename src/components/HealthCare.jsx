        ...
        <>
            <div className="flex w-[95%] m-auto" >
                    ...
                    <div className="w-3/5 relative "> 
                        ...
                        <div className="w-[65%] h-[200px] bg-body-color p-[20px] absolute rounded-md rounded-bl-none bottom-0 right-0">
                            <div className=" p-[20px] rounded-[15px] bg-health-care-bg">
                                ...
                                />
                            <p className="text-[15px] mb-0 font-sora text-white">300+ Appointment Booking Confirm for this Week</p>
                            </div>
                        </div>
                    </div>
                    <div className="w-2/5  p-2 "> {/* Added flex to center image */}
                        <img
                ...
                <div className="w-1/2 pl-[90px] p-0">
                    <div className="">
                        <h4 class="uppercase inline px-[23px] py-[3px] rounded-[30px] bg-white text-btn-color">About Medipay Billing </h4>
                        <div style={headingStyle} className="mt-5">Streamlining</div>
                        ...
                        <p className="font-[28px] text-p-color text-justify pt-[30px] font-roboto ">At Medipay Billing, we are committed to delivering comprehensive revenue cycle management solutions that simplify billing processes for healthcare providers. With our industry expertise and dedication to excellence, we help medical practices optimize their financial performance.</p>
                        <button className="px-[35px] py-[18px] bg-g-blue text-white text-center mt-[30px] rounded-[50px]">Know More<i className="fa-solid fa-arrow-right ml-2 transform rotate-[320deg] inline-block" style={{ marginLeft: '8px' }}></i></button>
                    </div>
