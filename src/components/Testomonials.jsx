      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          <div className="text-center">
            <p className="text-lg font-medium text-white font-sora">
              2,157 people have said how good Rareblocks
            </p>
            <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl xl:text-5xl font-sora">
          ...
          <div className="mt-8 text-center md:mt-16 md:order-3">
            <a
              href="#"
              title=""
              className="pb-2 text-base font-bold leading-7 text-white transition-all duration-200 border-b-2 border-white hover:border-gray-600 font-sora focus:outline-none focus:ring-1 focus:ring-white focus:ring-offset-2 hover:white"
            >
              {" "}
