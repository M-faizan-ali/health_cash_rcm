...
export default function TrustedLeaders() {
  return (
    ...
    <div className="sm:w-full lg:w-[1140px] m-auto mt-[100px] mb-[100px]">
      <div className="flex flex-wrap md:justify-center w-full sm:gap-[15px] lg:gap-0">
        {/* 1st section */}
        <div className="flex gap-5 sm:basis-full md:basis-1/2 lg:basis-1/3 justify-center">
