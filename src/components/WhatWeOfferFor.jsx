...
export default function WhatWeOfferFor() {
  return (
    ...
    >
      ...
      <div className="max-w-[1140px] mx-auto flex gap-5 ">
        <div className="block w-[355.333px] mr-[30px] relative cursor-pointer">
          <div className="image-container">
            <a href="#" className="group block">
              <img
                src="https://medipaybilling.com/wp-content/uploads/2024/09/Virtual-Assistance.jpg"
                alt=""
                className="rounded-[15px] transition-transform duration-300 ease-in-out transform group-hover:scale-110"
              />
            </a>
