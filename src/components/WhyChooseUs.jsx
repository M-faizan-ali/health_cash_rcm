  ...
  return (
    <>
      <div className="w-[90%] m-auto mt-[100px]">
        ...
        <div class="flex sm:flex-col lg:flex-row gap-9">
          {/* first section */}

          <div className="sm:w-full lg:w-[28%] max-w-full box-border">
            ...
            <div>
                  ...
                  <p className="font-roboto text-[#666]">
                    Our team’s deep knowledge of revenue cycle management ensures compliance and maximizes your revenue.
                  </p>
            </div>
      </div>
    ...
    <div>
      ...
      <p className="font-roboto text-[#666]">
        Our team’s deep knowledge of revenue cycle management ensures compliance and maximizes your revenue.
          ...
          {/* second section  */}
          <div className="sm:w-[100%] lg:w-[44%]">
          ...
          {/* 3rd section */}
          <div className="sm:w-[100%] lg:w-[28%]">
