...
export const allServicesContent = {
    ...
    content: ` 
               <div class="flex gap-4 items-start mb-10">
                ...
                <div>
                  ...
                  <div class="*:mb-5">
                    <p class="${styles.paraStyle}">
                      Our virtual assistance services offer numerous benefits, including:
                    </p>

                    <div class="flex items-start justify-between gap-5">
                      <ul class="*:text-lg *:mb-2">
                        <li class="flex gap-2 ${styles.tickList}">
                        ...
                        <svg class="w-10 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
                          ...
                          Cost-Effective Solutions: Save on overhead costs associated with full-time staff.
                       ...
                       <li class="flex gap-2 ${styles.tickList}">
                        ...
                        <svg class="w-10 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
                          ...
                          Flexibility: Tailor our services to meet your specific needs and adjust as required.
                      ...
                      <ul class="*:text-lg">
                        ...
                        <svg class="w-10 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
                          ...
                          Enhanced Productivity: Focus your energy on patient care while we handle administrative tasks.
                        ...
                        <svg class="w-10 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
                          ...
                          Expert Support: Benefit from experienced professionals who understand the healthcare industry.
                ...
                <div>
                  <h1 class="${styles.mainHeadingStyle}">
                    Our Virtual Assitance Services
                  </h1>

                  <div class="*:mb-5">
                    <div class="flex items-start justify-between gap-5 flex-wrap">
                      <div class=" *:mb-2 w-[48%]">
                        <h2 class="${styles.subHeadingStyle}">
                          1. Appointment Scheduling
                        </h2>
                        <p class="${styles.paraStyle}">
                          Streamline your appointment scheduling process with our efficient virtual assistants. We manage patient appointments, coordinate with providers, and handle rescheduling or cancellations to ensure your schedule runs smoothly.edita illo? Consequatur repudiandae odio id cum
                          et!
                        </p>
                        <ul class="list-disc ml-10">
                          <li class="${styles.boldli}">
                      ...
                      <div class=" *:mb-2 w-[48%]">
                        ...
                        <p class="${styles.paraStyle}">
                          Our team handles the organization and maintenance of medical records, ensuring that patient information is accurate, up-to-date, and easily accessible while adhering to privacy regulations.
                        </p>
                        <ul class="list-disc ml-10">
                          <li class="${styles.boldli}">
                      ...
                      <div class=" *:mb-2 w-[48%]">
                        <h2 class="${styles.subHeadingStyle}">
                          3. Billing and Coding Support
                        </h2>
                        <p class="${styles.paraStyle}">
                          Let us assist with the administrative aspects of billing and coding. We ensure that all necessary documentation is in place and correctly coded, streamlining your revenue cycle and minimizing errors.
                        </p>
                        <ul class="list-disc ml-10">
                          <li class="${styles.boldli}">
                          ...
                          <li class="${styles.boldli}">
                            Code Verification and Accuracy Checks
                          </li>
                          <li class="${styles.boldli}">
                      ...
                      <div class=" *:mb-2 w-[48%]">
                        ...
                        <p class="${styles.paraStyle}">
                          Enhance your patient communication with our virtual assistants managing routine queries, appointment reminders, and follow-up calls. We provide a professional and consistent point of contact for your patients.
                        </p>
                        <ul class="list-disc ml-10">
                          <li class="${styles.boldli}">
                      ...
                      <div class=" *:mb-2 w-[48%]">
                        ...
                        <p class="${styles.paraStyle}">
                          Our virtual assistants are equipped to handle various administrative tasks that keep your practice running efficiently. From data entry to managing correspondence, we’ve got you covered.
                        </p>
                        <ul class="list-disc ml-10">
                          <li class="${styles.boldli}">
                      ...
                      <div class=" *:mb-2 w-[48%]">
                        ...
                        <p class="${styles.paraStyle}">
                          Ensure timely and accurate insurance verification with our virtual assistance. We manage the verification process and handle authorization requests, reducing delays and streamlining patient care.
                        </p>
                        <ul class="list-disc ml-10">
                          <li class="${styles.boldli}">
                          ...
                          <li class="${styles.boldli}">
                            Authorization Requests and Follow-Ups
                          </li>
                          <li class="${styles.boldli}">
                ...
                <div class="">
                  <h1 class="${styles.mainHeadingStyle}">How It Works</h1>

                  <div class="*:mb-5">
                    <ol class="list-decimal">
                      <li class="${styles.paraStyle}">
                        <span class="${styles.boldli}">Consultation:</span>
                        Begin with a consultation to understand your specific needs and determine how our virtual assistance can best support your practice.
                      </li>
                      <li class="${styles.paraStyle}">
                        <span class="${styles.boldli}">Customized Plan:</span>
                          We develop a tailored plan that outlines the services we’ll provide and the processes we’ll follow.
                      </li>
                      <li class="${styles.paraStyle}">
                        <span class="${styles.boldli}">Implementation:</span>
                        Our virtual assistants begin working according to the agreed plan, seamlessly integrating with your team and systems.
                      </li>
                      <li class="${styles.paraStyle}">
                        <span class="${styles.boldli}">Ongoing Support :</span>
                        We offer continuous support and adjustments as needed to ensure our services remain aligned with your practice’s goals.
                      </li>
                    </ol>
                  </div>
                </div>
  ...
  "medical-billing": {
    ...
    content: ` 
               <div class="flex gap-4 items-start mb-10">
                    ...
                    <div class="flex items-start justify-between gap-5">
                      <ul class="*:text-lg *:mb-2">
                        <li>
                          ...
                          saepe vel tempora modi mollitia?
                        </li>
                        <li>
                          <span>tick icon</span>
                          Lorem ipsum dolor sit amet consectetur adipisicing
                  ...
                  <div class="*:mb-5">
                    <div class="flex items-start justify-between gap-5 flex-wrap">
                      <div class=" *:mb-2 w-[48%]">
                        ...
                        <p class="text-xl">
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Dolorem rerum similique iure repellendus
                          voluptas, eligendi inventore aliquam. Deserunt sunt
                          sint quam debitis magnam consectetur doloribus,
                          dolore ea, et autem quae illum exercitationem
                          expedita illo? Consequatur repudiandae odio id cum
                          et!
                        </p>
                        <ul class="list-disc ml-10">
                          <li class="font-bold text-xl mb-1">
                            Lorem, ipsum dolor.
                          </li>
                          <li class="font-bold text-xl mb-1">
                            Lorem, ipsum dolor.
                ...
                <div class="">
                  <h1 class="text-[45px] font-bold mb-5">How It Works</h1>
                  ...
                  <div class="*:mb-5 ml-8">
                    <ol class="list-decimal">
                      <li class="text-xl mb-4">
                        ...
                        Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Ab, a doloremque iusto veniam delectus
                        architecto.
                      </li>
                      <li class="text-xl mb-4">
                        <span class="font-bold">Lorem, ipsum. :</span>
    ...
    faqs: [
      {
        question: "Q1 this is very easy question",
        answer: "yes i dont kknow the answer",
        isOpen: false,
      },
      {
        question: "Q1 this is very easy question",
  ...
  "medical-credentialing": {
    ...
    image:
      "https://medipaybilling.com/wp-content/uploads/2024/09/Virtual-Assistance.jpg",
    content: `Medical credentialing involves verifying and validating the qualifications of healthcare providers.`,
    faqs: [
      {
    ...
    <ul>
      ...
      },
      {
        ...
        answer:
          "It ensures patient safety and compliance with regulatory standards.",
        isOpen: false,
      },
    ],
    summary:
  ...
  "revenue-cycle-management": {
    ...
    image:
      "https://medipaybilling.com/wp-content/uploads/2024/09/Virtual-Assistance.jpg",
    content: `RCM manages the financial processes in healthcare, from patient registration to final payment.`,
    faqs: [
      {
        question: "What does RCM stand for?",
        answer: "RCM stands for Revenue Cycle Management.",
        isOpen: false,
      },
      {
        question: "What are the key steps in RCM?",
        answer:
          "The key steps include patient registration, claim submission, payment processing, and denial management.",
        isOpen: false,
      },
    ],
    summary:
  ...
  "front-desk": {
    ...
    image:
      "https://medipaybilling.com/wp-content/uploads/2024/09/Virtual-Assistance.jpg",
    content: `Front desk services involve patient scheduling, reception, and administrative support.`,
    faqs: [
      {
        question: "What are the responsibilities of a medical front desk?",
        answer:
          "Responsibilities include scheduling appointments, answering queries, and managing patient records.",
        isOpen: false,
      },
      {
        question: "How does the front desk impact patient experience?",
        answer:
          "The front desk is often the first point of contact, making it critical for ensuring a positive patient experience.",
        isOpen: false,
      },
    ],
    summary:
  ...
  "medical-transcriptions": {
    ...
    image:
      "https://medipaybilling.com/wp-content/uploads/2024/09/Virtual-Assistance.jpg",
    content: `Medical transcription involves converting audio recordings of doctors into written documents.`,
    faqs: [
      {
        question: "What is medical transcription?",
        answer:
          "Medical transcription is the process of converting audio recordings of healthcare professionals into written text.",
        isOpen: false,
      },
      {
        question: "Why is transcription important in healthcare?",
        answer:
          "It ensures accurate documentation for patient records, billing, and legal compliance.",
        isOpen: false,
      },
    ],
    summary:
...
<br />
 ...
 `,
    faqs: [
      {
        question: "What is virtual assistance in healthcare?",
        answer:
          "Virtual assistance refers to remote support services, including scheduling, billing, and patient communication.",
        isOpen: false,
      },
      {
        question: "What are the benefits of virtual assistance?",
        answer:
          "Benefits include cost savings, improved efficiency, and flexibility.",
        isOpen: false,
      },
    ],
    summary:
